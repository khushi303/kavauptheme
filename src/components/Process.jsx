    ...
    return (
        <div className="bg-bgprocess xl:py-32 py-16 ">
            <div data-aos="fade-down" className="container xl:py-3">
                <h2 className="sm:text-xl text-lg leading-md font-semibold text-center text-black-800 mb-7 xl:pb-0.5">Our process</h2>
                ...
                <p className="text-sm font-normal max-w-[656px] text-center opacity-70 mx-auto leading-xxl">Once we're finished with your web or mobile app, we provide a web-based content manager to make quick, easy updates in the app. We also host and provide ongoing support for our clients.
                </p>
            </div>
        </div>
    )
