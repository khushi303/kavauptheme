            ...
            <div className="container xl:max-w-[1190px] xl:mt-0 mt-10">
                <div className="flex items-center justify-between lg:py-6 py-4">
                    ...
                    <div className={`${isOpen ? "max-lg:left-0" : "max-lg:left-[-100%]"} flex max-lg:fixed max-lg:top-0 max-lg:h-full z-50 max-lg:w-full max-lg:transition-all max-lg:duration-300 max-lg:ease-linear max-lg:bg-bgprocess max-lg:min-h-screen max-lg:flex-col gap-10 items-center justify-center relative`}>
                        ...
                        <div className={`absolute lg:top-[30px] top-[62%] lg:left-7 left-0 lg:right-[unset] mx-auto right-0 lg:w-[220px] lg:h-[240px] w-[150px] border-[1.5px] border-solid border-bgcirclehead pt-3 z-40 bg-white rounded ${show ? 'hidden' : 'block'}`}>
                            <input type="text" placeholder="Type here" className="w-full outline-none py-2.5 border-0 text-xxsm font-normal leading-md text-lightgray-900 placeholder:text-center placeholder:text-lightgray-900" />
