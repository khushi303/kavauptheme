    ...
    return (
        <>
            <div className="container xl:pt-24 xl:mt-1 pt-12">
                <h2 data-aos="fade-right" className="sm:text-5xl text-ls font-semibold !leading-lg text-center xl:mb-20 mb-10">Building Reliable Solutions for <span className="lg:block">Businesses, Brands, & Startups</span></h2>
            </div>
            <div className="container xl:max-w-[1534px] flex items-center xl:justify-end">
                <div className="xl:max-w-[1320px] w-full flex flex-wrap">
                    <div data-aos="zoom-in" className="xl:w-5/12 lg:w-6/12 flex flex-col justify-center items-start xl:pr-0 lg:pr-7">
                        <h2 className="sm:text-lg text-sd font-semibold text-black-800 !leading-lg xl:mb-6 mb-4">Web Apps</h2>
                        <p className="text-xl font-semibold text-learncolor !leading-xlg xl:mb-4 mb-2">Custom Web App Development</p>
                        ...
                        <p className="text-xl font-semibold text-learncolor !leading-xlg xl:mb-4 mb-2">Custom Web Apps Solve Unique Business Needs
                        </p>
