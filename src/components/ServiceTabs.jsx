    ...
    return (
        <>
            <div className="container xl:max-w-[1190px] xl:pt-24 pt-16">
                <h2 className="sm:text-xl text-xslg font-semibold leading-lg text-center xl:mb-20 mb-10 xl:mt-1">Services what we provide</h2>
                <div className="flex flex-wrap justify-between">
                    <ul className="lg:w-6/12 flex lg:flex-col flex-row items-center gap-5 w-full max-lg:overflow-x-scroll tabs">
                    ...
                    <div className="lg:w-6/12 w-full lg:mt-0 mt-8">
                        <div className={opentab === 1 ? "block" : "hidden"}>
                            <h3 className="text-xmd font-semibold leading-msxl lg:mb-5 mb-3 text-black-800">Saas</h3>
                            <p className="text-sm font-normal leading-xxl text-lightgray-400 ff_nunito">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                        ...
                        <div className={opentab === 2 ? "block" : "hidden"}>
                            <h3 className="text-xmd font-semibold leading-msxl lg:mb-5 mb-3 text-black-800 ">Reporting</h3>
                            <p className="text-sm font-normal leading-xxl text-lightgray-400 ff_nunito">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                            <div className="flex items-center justify-center lg:mt-[30px] mt-5">
                                <Image src={tabimg} alt="tabimg" className="max-w-[444px] w-full" />
                            </div>
                        ...
                        <div className={opentab === 3 ? "block" : "hidden"}>
                            <h3 className="text-xmd font-semibold leading-msxl lg:mb-5 mb-3 text-black-800 ">CMS</h3>
                            <p className="text-sm font-normal leading-xxl text-lightgray-400 ff_nunito">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                            <div className="flex items-center justify-center lg:mt-[30px] mt-5">
                                <Image src={tabimg} alt="tabimg" className="max-w-[444px] w-full" />
                            </div>
                        ...
                        <div className={opentab === 4 ? "block" : "hidden"}>
                            <h3 className="text-xmd font-semibold leading-msxl lg:mb-5 mb-3 text-black-800 ">Legacy application support</h3>
                            <p className="text-sm font-normal leading-xxl text-lightgray-400 ff_nunito">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                            <div className="flex items-center justify-center lg:mt-[30px] mt-5">
                                <Image src={tabimg} alt="tabimg" className="max-w-[444px] w-full" />
                            </div>
                        ...
                        <div className={opentab === 5 ? "block" : "hidden"}>
                            <h3 className="text-xmd font-semibold leading-msxl lg:mb-5 mb-3 text-black-800 ">System integrations</h3>
                            <p className="text-sm font-normal leading-xxl text-lightgray-400 ff_nunito">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                            <div className="flex items-center justify-center lg:mt-[30px] mt-5">
                                <Image src={tabimg} alt="tabimg" className="max-w-[444px] w-full" />
                            </div>
                        ...
                        <div className={opentab === 6 ? "block" : "hidden"}>
                            <h3 className="text-xmd font-semibold leading-msxl lg:mb-5 mb-3 text-black-800 ">Consulting</h3>
                            <p className="text-sm font-normal leading-xxl text-lightgray-400 ff_nunito">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes.</p>
                            <div className="flex items-center justify-center lg:mt-[30px] mt-5">
                                <Image src={tabimg} alt="tabimg" className="max-w-[444px] w-full" />
                            </div>
