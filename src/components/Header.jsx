                ...
                <div className="bg-bgheader rounded-xxl flex items-center justify-end xl:px-16 xl:py-10 py-6 2xl:pt-0 px-6">
                    <div className="flex flex-wrap flex-row items-center xl:max-w-[1459px]">
                        <div data-aos="fade-right" className="lg:w-6/12 w-full lg:pr-5">
                            <h2 className="xl:text-xxl lg:text-4xl md:text-xxl font-semibold !leading-lg sm:text-4xl text-xd text-navtextcolor max-w-[681px]">Custom <span className="text-headingcolor">software development </span>from concept to completion
                            ...
                            <div className="flex items-center sm:gap-7 gap-5 2xl:mt-12 mt-8 flex-wrap">
                                ...
                                <a href="tel:+1234567890" className="text-navtextcolor group text-nowrap xl:pl-0.5 flex items-center gap-4 text-lg font-semibold !leading-xsm">Try it for free <span><HeaderArrow /></span></a>
                            </div>
                        </div>
